...
<div class= "container">	
		...
		<h:form>
			...
			<tr>
				<td><h:inputText style="width:160px" id="cardID" value="#{pharmacyEncounterService.cardID }" required="true"/></td>
				<td><h:inputText style="width:160px" id="firstName" value="#{pharmacyEncounterService.firstName }" required="false" /></td>
				<td><h:inputText style="width:160px" id="lastName" value="#{pharmacyEncounterService.lastName }" required="false"/></td>
			</tr>
